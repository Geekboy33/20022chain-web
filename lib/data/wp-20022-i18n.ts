...
const fr: WpContent = {
  ...
  tocItems: [
    ...
    '05 — Format natif de messages ISO 20022',
    '06 — Registre ISIN et classification des actifs',
    '07 — Système de vérification ViewsRight',
    '08 — Système de scellés et couches de confiance',
    ...
    '14 — Arbres Verkle et gestion d\'état',
    ...
    '21 — Catalogue de contrats intelligents déployés',
    '22 — Registre d\'instruments financiers ISIN',
  ...
  backCover: {
    ...
    part: 'Partie de l\'écosystème ARCHT',
...
const ru: WpContent = {
  ...
  tocItems: [
    ...
    '14 — Деревья Verkle и управление состоянием',
    ...
    '19 — Модель безопасности и система аудита',
    '20 — Дорожная карта 2026–2028',
    '21 — Каталог развёрнутых смарт-контрактов',
    '22 — Реестр финансовых инструментов ISIN',
    '23 — ViewsRight: Интеллектуальная собственность в блокчейне',
    '24 — Нативная система адресов: Читаемые идентификаторы',
  ],
  backCover: {
    title: '20022Chain',
    subtitle: 'Блокчейн на базе ISO 20022',
...
const ar: WpContent = {
  ...
  cover: {
    ...
    subtitle: 'البلوكتشين الأصلي لمعيار ISO 20022\nللتسوية المؤسسية للأصول الحقيقية',
    version: 'الإصدار 1.0 · فبراير 2026',
  },
  tocTitle: 'جدول المحتويات',
  tocItems: [
    '01 — لماذا توجد 20022Chain',
    '02 — الهندسة المعمارية: 12 نظامًا فرعيًا بالتفصيل',
    '03 — آلية إجماع ArchPoS',
    '04 — محرك التنفيذ المتوازي',
    '05 — تنسيق الرسائل الأصلي ISO 20022',
    ...
    '24 — نظام العناوين الأصلي: معرّفات قابلة للقراءة',
  ],
  backCover: {
    title: '20022Chain',
    subtitle: 'بلوكتشين ISO 20022 الأصلي',
    part: 'جزء من نظام ARCHT البيئي',
